...
%  - content.tex: The manuscript text (minus the abstract).
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Set a class and general configuration
\documentclass[onecolumn,11pt,A4]{article}
...
\begin{FlushLeft}
    ...
    \\[0.3cm]
    {Revisions submitted to \textit{\Journal{}} after peer-review on \RevisionAOn.}
\end{FlushLeft}
