...
Therefore, function $a_j(x_i, y_i, z_i) = \vecbf{b}_j(x_i, y_i, z_i) \cdot \uvec{F}$, in which $\vecbf{b}_j(x_i, y_i, z_i)$ is the magnetic field of the $j$-th source with unit magnetic moment $\hat{\mathbf{m}}_j$.
