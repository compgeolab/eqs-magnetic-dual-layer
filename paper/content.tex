...
\noindent
For the majority of crustal anomalies measured by airborne and shipborne surveys, $\vec{\mathbf{B}} \ll \vec{\mathbf{F}}$ and $\vert \vec{\mathbf{B}} \vert$ is negligible. Consequently, $\Delta T$ can be approximated as \citep{Blakley1995}
