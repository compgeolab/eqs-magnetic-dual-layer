...
def complicated_synthetic(largest_anomaly, grid_anomaly, scatter_anomaly, north_anomaly, south_anomaly, regional):
    ...
    # Largest source
    # 1st part
    source_coordinates.append(vd.profile_coordinates((260e3,-8.245e6),(310e3,-8.265e6), size=2000, extra_coords=-5e3)[0])
    dipole_moments.append(eqs.angles_to_vector(largest_anomaly[0], largest_anomaly[1], np.full(2000, 5e8)))
    source_coordinates.append(vd.profile_coordinates((260e3,-8.25e6),(310e3,-8.27e6), size=2000, extra_coords=-23)[0])
    dipole_moments.append(eqs.angles_to_vector(largest_anomaly[0], largest_anomaly[1], np.full(2000, 5e8)))
    source_coordinates.append(vd.profile_coordinates((260e3,-8.255e6),(310e3,-8.275e6), size=2000, extra_coords=-5e3)[0])
    dipole_moments.append(eqs.angles_to_vector(largest_anomaly[0], largest_anomaly[1], np.full(2000, 5e8)))
    source_coordinates.append(vd.profile_coordinates((260e3,-8.26e6),(310e3,-8.28e6), size=2000, extra_coords=-5e3)[0])
    dipole_moments.append(eqs.angles_to_vector(largest_anomaly[0], largest_anomaly[1], np.full(2000, 5e8)))
    source_coordinates.append(vd.profile_coordinates((260e3,-8.265e6),(310e3,-8.285e6), size=2000, extra_coords=-5e3)[0])
    dipole_moments.append(eqs.angles_to_vector(largest_anomaly[0], largest_anomaly[1], np.full(2000, 5e8)))
    source_coordinates.append(vd.profile_coordinates((260e3,-8.27e6),(310e3,-8.29e6), size=2000, extra_coords=-5e3)[0])
    dipole_moments.append(eqs.angles_to_vector(largest_anomaly[0], largest_anomaly[1], np.full(2000, 5e8)))
    source_coordinates.append(vd.profile_coordinates((260e3,-8.275e6),(310e3,-8.295e6), size=2000, extra_coords=-5e3)[0])
    dipole_moments.append(eqs.angles_to_vector(largest_anomaly[0], largest_anomaly[1], np.full(2000, 5e8)))
    source_coordinates.append(vd.profile_coordinates((270e3,-8.26e6),(310e3,-8.275e6), size=2000, extra_coords=-5e3)[0])
    dipole_moments.append(eqs.angles_to_vector(largest_anomaly[0], largest_anomaly[1], np.full(2000, 5e8)))
    source_coordinates.append(vd.profile_coordinates((275e3,-8.26e6),(310e3,-8.28e6), size=2000, extra_coords=-5e3)[0])
    dipole_moments.append(eqs.angles_to_vector(largest_anomaly[0], largest_anomaly[1], np.full(2000, 5e8)))
    source_coordinates.append(vd.profile_coordinates((280e3,-8.27e6),(310e3,-8.285e6), size=2000, extra_coords=-5e3)[0])
    dipole_moments.append(eqs.angles_to_vector(largest_anomaly[0], largest_anomaly[1], np.full(2000, 5e8)))
    source_coordinates.append(vd.profile_coordinates((280e3,-8.29e6),(325e3,-8.3e6), size=2000, extra_coords=-5e3)[0])
    dipole_moments.append(eqs.angles_to_vector(largest_anomaly[0], largest_anomaly[1], np.full(2000, 5e8)))
    # 2nd part
    ...
    dipole_moments.append(eqs.angles_to_vector(largest_anomaly[0], largest_anomaly[1], np.full(4000, 5e8)))
    source_coordinates.append(vd.profile_coordinates((310e3,-8.315e6),(380e3,-8.335e6), size=4000, extra_coords=-5e3)[0])
    dipole_moments.append(eqs.angles_to_vector(largest_anomaly[0], largest_anomaly[1], np.full(4000, 5e8)))   
    ...
    dipole_moments.append(eqs.angles_to_vector(largest_anomaly[0], largest_anomaly[1], np.full(4000, 5e8)))
    # 4th part
    source_coordinates.append(vd.profile_coordinates((345e3,-8.35e6),(395e3,-8.36e6), size=4000, extra_coords=-5e3)[0])
    dipole_moments.append(eqs.angles_to_vector(largest_anomaly[0], largest_anomaly[1], np.full(4000, 5e8)))
    source_coordinates.append(vd.profile_coordinates((345e3,-8.355e6),(395e3,-8.365e6), size=4000, extra_coords=-5e3)[0])
    dipole_moments.append(eqs.angles_to_vector(largest_anomaly[0], largest_anomaly[1], np.full(4000, 5e8)))
    source_coordinates.append(vd.profile_coordinates((345e3,-8.36e6),(395e3,-8.37e6), size=4000, extra_coords=-5e3)[0])
    dipole_moments.append(eqs.angles_to_vector(largest_anomaly[0], largest_anomaly[1], np.full(4000, 5e8)))
