...
def icegrav_synthetic(source1, source2, source3, source4, dike1, dike2, dipole, regional_dipole, regional):
    ...
    # Regional dipole
    coordinates.append([[2.025e6], [2.87e6], [-60e3]])
    _dipole_moment_e, _dipole_moment_n, _dipole_moment_u = hm.magnetic_angles_to_vec(6e13, regional_dipole[0], regional_dipole[1])
    dipole_moments.append(np.array([[_dipole_moment_e], [_dipole_moment_n], [_dipole_moment_u]]))
    coordinates.append([[2.02e6], [2.86e6], [-60e3]])
    _dipole_moment_e, _dipole_moment_n, _dipole_moment_u = hm.magnetic_angles_to_vec(6e13, regional_dipole[0], regional_dipole[1])
    dipole_moments.append(np.array([[_dipole_moment_e], [_dipole_moment_n], [_dipole_moment_u]]))
    coordinates.append([[2.03e6], [2.86e6], [-60e3]])
    _dipole_moment_e, _dipole_moment_n, _dipole_moment_u = hm.magnetic_angles_to_vec(6e13, regional_dipole[0], regional_dipole[1])
    dipole_moments.append(np.array([[_dipole_moment_e], [_dipole_moment_n], [_dipole_moment_u]]))
    coordinates.append([[2.025e6], [2.85e6], [-60e3]])
    _dipole_moment_e, _dipole_moment_n, _dipole_moment_u = hm.magnetic_angles_to_vec(6e13, regional_dipole[0], regional_dipole[1])
    dipole_moments.append(np.array([[_dipole_moment_e], [_dipole_moment_n], [_dipole_moment_u]]))
    ...
    upward = vd.synthetic.CheckerBoard(region=region, amplitude=15e3, w_east=0.25e6, w_north=0.25e6).predict((easting, northing)) + -50e3
    ...
    dipole_moments.append(np.array(hm.magnetic_angles_to_vec(np.full(900,4e12), regional[0], regional[1])))
